...
<template>
  <main :class="[`l-page flex-col landing-bg main flex-col mb-max-w ${margin}` ]">
    <header role="top container" 
    class="bg-wh flex-rw mb-flex-col mb-max-w">
      <div class=" mb-j-ct mb-p-lr-0 p-tb-40 flex-col wt-1 mb-max-w mg-tp-30 p-lr-3 mb-m-t-300 ">
        <h1 class=" flex-rw mb-j-ct mb-max-w font-s-mx  line-ht-10">Next Generation <br> digital banking</h1>

        <p class="paragraph mg-tp-30">
          Take your financial life online. your Easybank account <br> will be a
          one-step-shop for spending ,saving, <br> budgeting, investing and much
          more.
        </p>
    ...
    <section 
    class="section-two mb-j-ct mb-m-0 padding-tp-60 bg-grey p-lr-3 mb-max-w mb-m-t-300 mb-p-lr-10 f-s-2" role="second col">
      <h1 class="mg-bm-20 text-a mb-f-s-1">Why choose Easybank? this{{ margin }}</h1>
      <p class="text-a mg-bm-20 f-s-3 w-3">
        We leverage Open Banking to turn your bank account into financial hub.
        <!-- <br /> -->
        Control your finances like never before
      </p>
      <div class="flex-rw content-cx gap-10 mb-flex-col">
        <PlainCard 
    ...
    <section class="mb-p-lr-10 mb-j-ct section-two mg-tp-0 bg-wh padding-tp-60 p-lr-3 mb-max-w">
    <h1 class="mg-bm-20 text-a">Latest Article</h1>
    <div class="flex-rw gap-1 content-cx gap-1 mb-flex-col">
  ...
  It’s easy to request an invite through the site ...</p>
    ...
    <footer class="footer flex-rw space-bw mb-j-ct bg-dark-blue p-tb-40 p-lr-3 mb-flex-col mb-max-w gap">
